...
class UserModel
{
  ...
  public function createUser( $user_user, $user_password, $rol_id,  $user_status_id)
  {
    $sql = "INSERT INTO `user` (user_user, user_password,role_id,user_status_id) VALUES ('$user_user','$user_password',$rol_id,$user_status_id);";
    $prepare_sql = $this->conn->query($sql);
    $this->objDB->connectMysqliClose();
    return true;
  }
